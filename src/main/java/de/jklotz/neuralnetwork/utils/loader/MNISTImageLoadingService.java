...
*/
public class MNISTImageLoadingService {
    ...
    public MNISTImageLoadingService(String labelFileName, String imageFileName) {
        this.labelFileName = labelFileName;
        this.imageFileName = imageFileName;
    }

    public List<MnistImage> loadMNISTImages(BiFunction<Integer, byte[], MnistImage> imageFactory) throws IOException {
        ...
        for (int i = 0; i < numberOfLabels; i++) {
            ...
            images.add(imageFactory.apply(label, imageData));
        }
